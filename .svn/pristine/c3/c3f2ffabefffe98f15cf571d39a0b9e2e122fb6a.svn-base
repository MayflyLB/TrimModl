...
del /s/q %SourcePath%\*.lib
del /s/q %SourcePath%\*.ilk
del /s/q %SourcePath%\*.ipch
del /s/q %SourcePath%\*.db
del /s/q %SourcePath%\*.opendb
rd /s/q %SourcePath%\ipch
rd /s/q %SourcePath%\x64
rd /s/q %SourcePath%\release
