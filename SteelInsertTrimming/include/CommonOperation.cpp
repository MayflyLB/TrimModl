...
void CommonOperation::extrudeVertex(const vccdata &vcc, bool flag, double len)
{
    if (!isTrimLClose)
    {
        ...
        if (vcc.a.curve != vcc.b.curve)
        {
            if (flag)
            {
                UF_VEC3_copy(vcc.a.end_point, const_cast<double*> ((const double*)vcc.a.vertexPt));
                UF_VEC3_copy(vcc.b.end_point, const_cast<double*> ((const double*)vcc.b.vertexPt));

                UF_VEC3_sub(vcc.a.end_point, vcc.a.start_point, dir);
                MyFun::getDirectionPos(dir, vcc.a.end_point, len, const_cast<double*> ((const double*)vcc.a.end_point));
                ...
                MyFun::getDirectionPos(dir, vcc.b.end_point, len, const_cast<double*> ((const double*)vcc.b.end_point));
            ...
            else
            {
                ...
                UF_VEC3_copy(vcc.a.vertexPt, const_cast<double*> ((const double*)vcc.a.end_point));
                UF_CURVE_edit_line_data(vcc.a.curve, &line_coords);

                UF_VEC3_copy(vcc.b.start_point, line_coords.start_point);
                UF_VEC3_copy(vcc.b.vertexPt, line_coords.end_point);
                UF_VEC3_copy(vcc.b.vertexPt, const_cast<double*> ((const double*)vcc.b.end_point));
                UF_CURVE_edit_line_data(vcc.b.curve, &line_coords);
